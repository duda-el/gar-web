              ...
              <div className="absolute inset-0 bg-[#0d0d0d] rounded-[3rem] border border-white/10 backdrop-blur-2xl shadow-2xl overflow-hidden z-20 transition-transform duration-500 group-hover:-translate-y-2">
                ...
                <div className="absolute inset-0 p-12 flex flex-col justify-between">
                  ...
                  <div className="space-y-6">
                    ...
                    <h2 className="text-white text-3xl font-black tracking-tight leading-tight uppercase italic">
                      Digital <br /> High-End <br /> Solutions
                    </h2>
                  </div>
                </div>
                <div
                  className="absolute -inset-full bg-gradient-to-r from-transparent via-white/5 to-transparent -rotate-45 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000 ease-in-out"
                  aria-hidden="true"
                />
              </div>
              <div
                className="absolute -bottom-6 -left-6 w-full h-full border border-primary/20 rounded-[3rem] z-10 transition-all duration-500 group-hover:scale-105"
                aria-hidden="true"
              />
            </motion.div>
          </div>
